...
public class MergePipelineTest {
    ...
    private final List<Transaction> SAMPLE_IMPORTS = List.of(
            ...
            new Transaction(new DateTime(2024,1,25,0,0,0).toDate(), 0, AccountEnum.BOC, "", BigDecimal.ZERO, BigDecimal.valueOf(1000), BigDecimal.valueOf(1000), Set.of("INTERNAL"), null, null),
            new Transaction(new DateTime(2024,1,25,0,0,0).toDate(), 1, AccountEnum.BOC, "", BigDecimal.valueOf(400), BigDecimal.ZERO, BigDecimal.valueOf(600), Set.of("SCHEDULE", "SCHEDULE-1"), null, null),
            new Transaction(new DateTime(2024,1,25,0,0,0).toDate(), 2, AccountEnum.BOC, "", BigDecimal.ZERO, BigDecimal.valueOf(90), BigDecimal.valueOf(510), Set.of("SCHEDULE", "SCHEDULE-1"), null, null),
    ...
    private final List<Transaction> SAMPLE_VIRTUALS = List.of(
            new Transaction(new DateTime(2024,1,25,0,0,0).toDate(), 0, AccountEnum.BOC, "", BigDecimal.ZERO, BigDecimal.valueOf(1000), BigDecimal.valueOf(1000), Set.of("Fund Transfer", VIRTUAL_TAG), null, null),
            new Transaction(new DateTime(2024,1,25,0,0,0).toDate(), 0, AccountEnum.BOC, "", BigDecimal.valueOf(400), BigDecimal.ZERO, BigDecimal.valueOf(600), Set.of("Electricity", VIRTUAL_TAG), Map.of(TransactionMeta.IMPORT_FILENAME, "Electricity Fee Jan 2024.pdf"), null),
            new Transaction(new DateTime(2024,1,25,0,0,0).toDate(), 0, AccountEnum.BOC, "", BigDecimal.ZERO, BigDecimal.valueOf(90), BigDecimal.valueOf(510), Set.of("Mobile Data", VIRTUAL_TAG), Map.of(TransactionMeta.IMPORT_FILENAME, "china-mobile-202401.pdf"), null)
    );
